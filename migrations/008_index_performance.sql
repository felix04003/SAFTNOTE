...
-- CONCURRENTLY retiré : migrate.js applique chaque fichier dans une
-- transaction (BEGIN/COMMIT), incompatible avec CREATE INDEX CONCURRENTLY.
-- Sans impact sur un schéma neuf (aucune donnée). Si cette migration doit
-- un jour être rejouée sur une base déjà volumineuse et sous trafic, créer
-- les index manquants hors migrate.js, statement par statement, en dehors
