...
const styles = StyleSheet.create({
  ...
  sectionTitre:  { fontSize: Typography.sm, fontWeight: Typography.bold, color: Colors.gray700 },
  ...
  noteType: { fontSize: Typography.sm, fontWeight: Typography.medium, color: Colors.gray700 },
