...
# SMS — optionnel en dev/test uniquement (OTP loggé si absent) ;
# OBLIGATOIRE en production depuis le lot E (audit 2026-09) : sans ces
# deux variables, validateEnv() (backend/src/utils/env.js) fait refuser
# le démarrage du serveur plutôt que de risquer de logguer les codes
# OTP en clair.
AT_API_KEY=...
AT_USERNAME=...
