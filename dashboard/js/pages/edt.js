 ...
 * 1. Le <select> classe partagé (#sel-classe-edt) est peuplé par app.js
 *    au chargement (GET /classes global) — cette page se contente de
 *    s'y abonner, pas de dupliquer le fetch.
 * 2. Sur changement de classe, charge l'EDT via GET /edt/classe/:classeId
 *    ainsi que les affectations de la classe (matière/enseignant
 *    disponibles pour le formulaire de créneau).
 * 3. directeur/super_admin (perm edt.creer) peuvent créer/modifier/
 *    supprimer un créneau ; les autres rôles restent en lecture seule.
 */
var PageEDT = {
  data: null,
  classeId: null,
